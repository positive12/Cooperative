...
/**
 * @version V2.11 7 June 2002 (c) 2000-2002 John Lim (jlim@natsoft.com.my). All rights reserved.
...
*/
 ...
 if (!defined('_ADODB_LAYER')) {
	 ...
	 */
	$ADODB_vers = 'V2.11 7 June 2002 (c) 2000-2002 John Lim (jlim@natsoft.com.my). All rights reserved. Released BSD & LGPL.';
	...
	*/
	...
	function Replace($table, $fieldArray, $keyCol,$autoQuote=false)
	{
		...
		} else $where = "$keyCol=$fieldArray[$keyCol]";
