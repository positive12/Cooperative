...
--
-- Host: localhost:3306
-- Generation Time: Mar 17, 2019 at 09:00 PM
...
(1, 'Edison Paul', 'Heramil', 'Filipino', '', 'Calajuan, Minglanilla Cebu', 23, 'Regular', '2019-03-18 03:22:53', 2000, 0),
(2, 'Flowry May ', 'Filipino', 'Heramil', 'Jr.', 'Poblcaion, Alcoy Cebu', 16, 'Regular', '2019-03-18 03:19:51', 1000, 0),
...
--
ALTER TABLE `Diposit`
  MODIFY `Idd` int(244) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `withdraw`
  MODIFY `Idw` int(255) NOT NULL AUTO_INCREMENT;
