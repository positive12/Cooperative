...
<head>
    <link rel="stylesheet" type="text/css" href="../Css/styless.css">
  	...
  	<form method="post" action="../php/transaction-exc.php">
  		<fieldset>
			<h2><legend>Add Transaction</legend></h2>
			<div><a href="../pages/transactions.php"> Multple Transaction</a></div>
        		...
        		<input type="text" name="amount" id="currency-field" pattern="^\₱\d{1,3}(,\d{3})*(\.\d+)?" value="" data-type="currency" placeholder="₱1,000,000.00">
        		<button type="submit" name="tras_exc">Add</button>
	</form>
