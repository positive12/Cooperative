    ...
    <body></br></br>
        <table id="example" class="display" style="width:100%">
                ...
                <?php
                  require'../php/connection.php';
                   ...
                   if (isset($_GET['Id'])) {
                    ...
                    $show = ("SELECT * from Diposit where mid='$id'");
                      ...
                      <tr id="">
                          ...
                          <td data-target="middlename"><center>₱ <?php $damount=$row['damount']; echo number_format($damount, 2);  ?></td>
                          <td data-target="exname"><center><?php echo $row['date']; ?></td>

                          <td>
                            <a onclick="return confirmDelete(this);"  href=../php/delete-transactions.php?idd=<?php echo $row['Idd']; ?>><img src="../images/delete.png" width="25" ></a>
            ...
            <tfoot>
                ...
                <?php
                require'../php/connection.php';
                $result = ("SELECT SUM(damount) AS value_sum FROM Diposit where mid ='$id'"); 
                ...
                <tr></tr>
                 <tr>
                    ...
                    <td> <a onclick="return confirmDelete(this);"  href=../php/clear.php?id=<?php echo $rows['mid']; ?>><img src="../images/drop.png" width="25" ></a>
                    <td></td>
                </tr>
        </table>
  <!--== DataTables =====-->
